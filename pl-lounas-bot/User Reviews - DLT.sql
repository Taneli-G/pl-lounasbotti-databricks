...
SELECT
  ...
  ,count_if(reaction_type LIKE 'dislike') as negative_reviews
  ,count(reaction_type) AS total_reviews
  ,positive_reviews / total_reviews AS positives_of_total
  ,neutral_reviews / total_reviews AS neutrals_of_total
  ,negative_reviews / total_reviews AS negatives_of_total
